...
class ArtistCompendium:
    ...
    def INPUT_TYPES(self):
        ...
        # Construct 'Artists.json' path
        file_path = os.path.join(p, 'Artists.json')
...
NODE_CLASS_MAPPINGS = {
    "ArtistCompendium": ArtistCompendium, 
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "ArtistCompendium": "Artist Compendium",
}